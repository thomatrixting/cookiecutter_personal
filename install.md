# configuration_of_enviroment_course_project guide installation
...
activate configuration_of_enviroment_course_project
```
...
To move beyond notebook prototyping, all reusable code should go into the `configuration_of_enviroment_course_project/` folder package. To use that package inside your project, install the project's module in editable mode, so you can edit files in the `configuration_of_enviroment_course_project` folder and use the modules inside your notebooks :
...
```python
from configuration_of_enviroment_course_project.utils.paths import data_dir
data_dir()
```
